...
public class AdminServiceImpl implements AdminService {
    ...
    @Override
    public AdminEntity findAdminByAdminId(String admin_id) throws UsernameNotFoundException{
    ...
    @Override
    public boolean checkIfAdminExist(String admin_id) {
    ...
    @Override
    public void resetPassword(String admin_id, ResetPasswordVO resetPasswordVO) {
